...
public class GroupTesting {
    ...
    @ParameterizedTest  //coklu parametreli  calisacagim icin
    ...
    void Carpim(int sonuc, int x, int y) {
      ...
      // Yapisi itibariyle Parent class gibi calisir dolayisiyla class seviyesinde test yapar
      @Nested//parent  test gibi kapsamındaki Class'ındakşi tum testleri aynı anda run eder
           // @Nested --> parent'i oldugu class level'da calışır
